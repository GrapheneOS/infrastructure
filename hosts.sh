declare -Ar hosts_hostname=(
    ...
    [ams.grapheneos.org]=grapheneos-ams
    [dal.grapheneos.org]=grapheneos-dal
...
declare -Ar hosts_type=(
    [dal.ns2.grapheneos.org]=container
    [fra.ns2.grapheneos.org]=container
    [yto.ns2.grapheneos.org]=container
    [mail.grapheneos.org]=container
    [ams.grapheneos.org]=metal
    [dal.grapheneos.org]=metal
    [fra.grapheneos.org]=metal
...
declare -Ar hosts_cpu_vendor=(
    [ams.grapheneos.org]=amd
    [dal.grapheneos.org]=amd
    [fra.grapheneos.org]=amd
...
declare -Ar hosts_authorized_keys=(
    ...
    [mad.ns1.grapheneos.org]=authorized_keys-replica-ns1
    ...
    [sto.ns1.grapheneos.org]=authorized_keys-replica-ns1
    ...
    [ams.ns2.grapheneos.org]=authorized_keys-replica-ns2
    [ber.ns2.grapheneos.org]=authorized_keys-replica-ns2
    [dal.ns2.grapheneos.org]=authorized_keys-replica-ns2
    [fra.ns2.grapheneos.org]=authorized_keys-replica-ns2
    ...
    [dal.grapheneos.org]=authorized_keys-replica-grapheneos
...
declare -Ar hosts_firewall=(
    ...
    [ams.grapheneos.org]=network
    [dal.grapheneos.org]=network-dal
    [fra.grapheneos.org]=network-fra
...
declare -Ar hosts_swap=(
    [ams.grapheneos.org]=32768
    [dal.grapheneos.org]=32768
    [fra.grapheneos.org]=32768
...
declare -Ar hosts_agcount=(
    [ams.grapheneos.org]=32
    [dal.grapheneos.org]=32
    [fra.grapheneos.org]=32
...
declare -Ar hosts_reserved_ports=(
    [ams.grapheneos.org]=7275
    [dal.grapheneos.org]=7275
    ...
    [matrix.grapheneos.org]=8080
)

declare -Ar hosts_tcp_wmem_max=(
    [ams.grapheneos.org]=33554432
    [dal.grapheneos.org]=33554432
    [fra.grapheneos.org]=33554432
...
declare -Ar hosts_conntrack_size=(
    ...
    [dal.grapheneos.org]=8388608
    [fra.grapheneos.org]=8388608
...
declare -Ar hosts_ipv4_address=(
    ...
    [dal.grapheneos.org]=121.127.40.19
    [fra.grapheneos.org]=87.249.129.100
...
declare -Ar hosts_ipv6_address=(
    ...
    [mad.ns1.grapheneos.org]=2a05:f480:2800:24b7:5400:06ff:fe01:ce01
    [mia.ns1.grapheneos.org]=2001:19f0:9000:2605:5400:05ff:feed:7df5
    ...
    [sto.ns1.grapheneos.org]=2a05:f480:2000:2941:5400:06ff:fe0b:d01f
    ...
    [ams.ns2.grapheneos.org]=2a12:8d05:100:340:26a3:f0ff:fe46:909f
    [ber.ns2.grapheneos.org]=2a12:8d02:2100:176:26a3:f0ff:fe49:eda8
    [dal.ns2.grapheneos.org]=2a02:6ea0:d207::1
    [fra.ns2.grapheneos.org]=2a02:6ea0:c75f:1::1
    ...
    [dal.grapheneos.org]=2a02:6ea0:d206::1
    [fra.grapheneos.org]=2a02:6ea0:c75f::1
...
readonly hosts_secondary=(
    {bom,chi,dal,fra,lax,lon,mad,mia,sao,sea,sin,sto,syd,tyo,waw}.ns1.grapheneos.org
    {ams,ber,dal,fra,iad,lon,mia,sea,sjc,sin,tyo}.ns2.grapheneos.org
    {ams,dal,fra,lax,lon,mia,sao,sea,sin,syd,tyo}.grapheneos.org
)
...
readonly hosts_grapheneos=(
    {ams,dal,fra,lax,lon,mia,sao,sea,sin,syd,tyo,yto}.grapheneos.org
)
