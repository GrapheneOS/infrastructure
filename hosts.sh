...
readonly hosts_secondary=(
    ...
    {ams,ber,dal,iad,lon,mia,sea,sjc,sin,tyo}.ns2.grapheneos.org
    {ams,dal,fra,lax,lon,mia,nue,sao,sea,sin,syd,tyo}.grapheneos.org
)
...
readonly hosts_grapheneos=(
    {ams,dal,fra,lax,lon,mia,nue,sao,sea,sin,syd,tyo,yto}.grapheneos.org
)
